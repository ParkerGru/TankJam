...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::flixel::FlxState_obj
{
	...
	public:
		...
		int _xgridright;
		int _ygrid;
		 ::flixel::FlxSprite guy;
		 ::flixel::FlxSprite guy2;
		 ::flixel::tile::FlxTileblock _ground;
		void create();
		...
		::String bakeColors(int color,::String asset, ::Dynamic alpha);
		::Dynamic bakeColors_dyn();
