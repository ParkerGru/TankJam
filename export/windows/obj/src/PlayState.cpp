...
HXLINE(  47)		this->guy->animation->addByIndices(HX_("idle",14,a7,b3,45),HX_("steve",d3,80,0e,84),::Array_obj< int >::fromData( _hx_array_data_46c2835d_3,13),HX_("",00,00,00,00),30,true,null(),null());
HXLINE(  48)		this->guy->animation->addByIndices(HX_("look_up",7b,db,27,1d),HX_("steve",d3,80,0e,84),::Array_obj< int >::fromData( _hx_array_data_46c2835d_4,10),HX_("",00,00,00,00),30,false,null(),null());
HXLINE(  49)		this->guy->animation->addByIndices(HX_("crouch",7a,a7,ba,82),HX_("steve",d3,80,0e,84),::Array_obj< int >::fromData( _hx_array_data_46c2835d_5,11),HX_("",00,00,00,00),30,false,null(),null());
HXLINE(  50)		this->guy->animation->addByIndices(HX_("jump",ee,c4,69,46),HX_("steve",d3,80,0e,84),::Array_obj< int >::fromData( _hx_array_data_46c2835d_6,19),HX_("",00,00,00,00),30,true,null(),null());
HXLINE(  51)		this->guy->animation->addByIndices(HX_("run",4b,e7,56,00),HX_("steve",d3,80,0e,84),::Array_obj< int >::fromData( _hx_array_data_46c2835d_7,17),HX_("",00,00,00,00),30,true,null(),null());
...
HXLINE(  60)		this->guy2->animation->addByIndices(HX_("idle",14,a7,b3,45),HX_("John",2b,5f,3e,31),::Array_obj< int >::fromData( _hx_array_data_46c2835d_8,13),HX_("",00,00,00,00),30,true,null(),null());
HXLINE(  61)		this->guy2->animation->addByIndices(HX_("look_up",7b,db,27,1d),HX_("John",2b,5f,3e,31),::Array_obj< int >::fromData( _hx_array_data_46c2835d_9,10),HX_("",00,00,00,00),30,false,null(),null());
HXLINE(  62)		this->guy2->animation->addByIndices(HX_("crouch",7a,a7,ba,82),HX_("John",2b,5f,3e,31),::Array_obj< int >::fromData( _hx_array_data_46c2835d_10,11),HX_("",00,00,00,00),30,false,null(),null());
HXLINE(  63)		this->guy2->animation->addByIndices(HX_("jump",ee,c4,69,46),HX_("John",2b,5f,3e,31),::Array_obj< int >::fromData( _hx_array_data_46c2835d_11,19),HX_("",00,00,00,00),30,true,null(),null());
HXLINE(  64)		this->guy2->animation->addByIndices(HX_("run",4b,e7,56,00),HX_("John",2b,5f,3e,31),::Array_obj< int >::fromData( _hx_array_data_46c2835d_12,17),HX_("",00,00,00,00),30,true,null(),null());
